...
public final class InputStreamAssertionTest extends AssertionTest {
    ...
    public void toByteArrayFullTest() {
        ...
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Check input stream bytes. Value should not be null.");
        }
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Message. Check input stream bytes. Value should not be null.");
        }
        try {
        ...
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Message. Check input stream bytes. Value should contain all of the expected values exactly in the specified order. Expected:<[1, 2]> but was:<[1, 2, 3]>");
        }
    }
