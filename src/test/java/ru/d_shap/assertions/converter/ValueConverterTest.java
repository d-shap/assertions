...
public final class ValueConverterTest extends AssertionTest {
    ...
    public void convertTest() {
        ...
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 6, true)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 6, true), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3, 4, 5);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 5, true)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 5, true), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3, 4, 5);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 4, true)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 4, true), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3, 4);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 3, true)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 3, true), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 2, true)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 2, true), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 1, true)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 1, true), Raw.<Integer>listAssertion()).containsExactlyInOrder(1);
