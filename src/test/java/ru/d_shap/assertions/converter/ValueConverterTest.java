...
public final class ValueConverterTest extends AssertionTest {
    ...
    public void convertTest() {
        ...
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 6)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 6), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3, 4, 5);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 5)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 5), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3, 4, 5);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 4)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 4), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3, 4);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 3)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 3), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2, 3);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 2)).isInstanceOf(List.class);
        Assertions.assertThat(ValueConverter.convert(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 2), Raw.<Integer>listAssertion()).containsExactlyInOrder(1, 2);
