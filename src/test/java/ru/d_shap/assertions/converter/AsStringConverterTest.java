...
public final class AsStringConverterTest extends AssertionTest {
    ...
    public void asStringValueConverterTest() {
        ...
        Assertions.assertThat(AsStringConverter.asString(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 5, true)).isEqualTo("[1, 2, 3, 4, 5]");
        Assertions.assertThat(AsStringConverter.asString(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 4, true)).isEqualTo("[1, 2, 3, 4]");
        Assertions.assertThat(AsStringConverter.asString(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 3, true)).isEqualTo("[1, 2, 3]");
        Assertions.assertThat(AsStringConverter.asString(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 2, true)).isEqualTo("[1, 2]");
        Assertions.assertThat(AsStringConverter.asString(DataHelper.createIterator(1, 2, 3, 4, 5), List.class, 1, true)).isEqualTo("[1]");
