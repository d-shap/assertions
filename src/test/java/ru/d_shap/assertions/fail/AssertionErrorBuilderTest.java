...
public final class AssertionErrorBuilderTest extends AssertionTest {
    ...
    public void buildWithSuppressedThrowableTest() {
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        ...
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).addSuppressedThrowable(new RuntimeException("rte")).build()).hasSuppressed(IOException.class, RuntimeException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).addSuppressedThrowable(new RuntimeException("rte")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new IOException("runtime exception")).addSuppressedThrowable(new RuntimeException("rte")).build()).hasSuppressedMessage(1, "rte");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).addSuppressedThrowable(new RuntimeException("rte")).build()).hasSuppressed(IOException.class, RuntimeException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).addSuppressedThrowable(new RuntimeException("rte")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).addSuppressedThrowable(new RuntimeException("rte")).build()).hasSuppressedMessage(1, "rte");
    }
    ...
    public void buildWithActualAndSuppressedThrowableTest() {
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("Actual:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("Actual:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("Actual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("Actual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.\n\tActual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.\n\tActual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
    }
    ...
    public void buildWithActualAndSuppressedThrowablesTest() {
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("Actual:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("Actual:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("Actual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("Actual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("message.\n\tActual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("message.\n\tActual:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasSuppressed(IOException.class, RuntimeException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasSuppressedMessage(1, "rte");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasSuppressed(IOException.class, RuntimeException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasSuppressedMessage(1, "rte");
    }
    ...
    public void buildWithActualAndExpectedAndSuppressedThrowableTest() {
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("Expected:<5> but was:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("Expected:<5> but was:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("Expected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("Expected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasMessage("message.\n\tExpected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasMessage("message.\n\tExpected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new IOException("runtime exception")).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(new ConversionException(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
    }
    ...
    public void buildWithActualAndExpectedAndSuppressedThrowablesTest() {
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance().addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription()).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription(), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), null, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("Expected:<5> but was:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("Expected:<5> but was:<<NULL>>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, null).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("Expected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("Expected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(null, String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasMessage("message.\n\tExpected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasMessage("message.\n\tExpected:<5> but was:<actual>");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressed(IOException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message"), String.class, "actual").addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")))).build()).hasSuppressedMessage(0, "runtime exception");

        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).isInstanceOf(AssertionError.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasMessage("message.");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasSuppressed(IOException.class, RuntimeException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new IOException("runtime exception"), new RuntimeException("rte"))).build()).hasSuppressedMessage(1, "rte");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasSuppressed(IOException.class, RuntimeException.class);
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasSuppressedMessage(0, "runtime exception");
        Assertions.assertThat(AssertionErrorBuilder.getInstance(new FailDescription("message")).addActual().addExpected(5).addSuppressedThrowable(DataHelper.createArrayList(new ConversionException(new IOException("runtime exception")), new RuntimeException("rte"))).build()).hasSuppressedMessage(1, "rte");
    }
