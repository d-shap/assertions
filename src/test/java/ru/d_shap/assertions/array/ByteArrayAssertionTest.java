...
public final class ByteArrayAssertionTest {
    ...
    public void containsTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).contains(3);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void doesNotContainTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).doesNotContain(1);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void containsAllTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAll((byte) 2, (byte) 3);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAll(2, 3);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values. Expected:<[2, 3]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAll(Arrays.asList((byte) 2, (byte) 3));
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values. Expected:<[2, 3]> but was:<[1, 2]>.");
        }
    ...
    public void containsAllInOrderTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAllInOrder((byte) 2, (byte) 1);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAllInOrder(2, 1);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values in the specified order. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAllInOrder(Arrays.asList((byte) 2, (byte) 1));
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values in the specified order. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
    ...
    public void containsExactlyTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactly((byte) 1, (byte) 1, (byte) 3, (byte) 2);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactly(1, 1, 3, 2);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly. Expected:<[1, 1, 3, 2]> but was:<[1, 2, 3, 4]>.");
        }
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactly(Arrays.asList((byte) 1, (byte) 1, (byte) 3, (byte) 2));
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly. Expected:<[1, 1, 3, 2]> but was:<[1, 2, 3, 4]>.");
        }
    ...
    public void containsExactlyInOrderTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactlyInOrder((byte) 2, (byte) 3, (byte) 1, (byte) 4);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactlyInOrder(2, 3, 1, 4);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly in the specified order. Expected:<[2, 3, 1, 4]> but was:<[1, 2, 3, 4]>.");
        }
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactlyInOrder(Arrays.asList((byte) 2, (byte) 3, (byte) 1, (byte) 4));
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly in the specified order. Expected:<[2, 3, 1, 4]> but was:<[1, 2, 3, 4]>.");
        }
    ...
    public void containsAnyTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAny((byte) 3, (byte) 4);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAny(3, 4);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain any of the expected values. Expected:<[3, 4]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsAny(Arrays.asList((byte) 3, (byte) 4));
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain any of the expected values. Expected:<[3, 4]> but was:<[1, 2]>.");
        }
    ...
    public void containsNoneTest() {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsNone((byte) 2, (byte) 1);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsNone(2, 1);
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should not contain any of the expected values. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).containsNone(Arrays.asList((byte) 2, (byte) 1));
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should not contain any of the expected values. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
    ...
    public void createListAssertionTest() {
        new ByteArrayAssertion(new byte[0], new FailDescription()).createListAssertion().isEmpty();
        new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription()).createListAssertion().isNotEmpty();

        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription()).createListAssertion().isEmpty();
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Value should be empty. Actual:<[1, 2]>.");
        }
        try {
            new ByteArrayAssertion(new byte[]{1, 2}, new FailDescription().addMessage("Message")).createListAssertion().isEmpty();
            Assertions.fail("ByteArrayAssertion test fail");
        } catch (AssertionError ex) {
