...
public final class ShortArrayAssertionTest {
    ...
    public void containsTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).contains(3);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void doesNotContainTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).doesNotContain(1);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void containsAllTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAll((short) 2, (short) 3);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAll(2, 3);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values. Expected:<[2, 3]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAll(Arrays.asList((short) 2, (short) 3));
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values. Expected:<[2, 3]> but was:<[1, 2]>.");
        }
    ...
    public void containsAllInOrderTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAllInOrder((short) 2, (short) 1);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAllInOrder(2, 1);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values in the specified order. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAllInOrder(Arrays.asList((short) 2, (short) 1));
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values in the specified order. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
    ...
    public void containsExactlyTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactly((short) 1, (short) 1, (short) 3, (short) 2);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactly(1, 1, 3, 2);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly. Expected:<[1, 1, 3, 2]> but was:<[1, 2, 3, 4]>.");
        }
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactly(Arrays.asList((short) 1, (short) 1, (short) 3, (short) 2));
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly. Expected:<[1, 1, 3, 2]> but was:<[1, 2, 3, 4]>.");
        }
    ...
    public void containsExactlyInOrderTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactlyInOrder((short) 2, (short) 3, (short) 1, (short) 4);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactlyInOrder(2, 3, 1, 4);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly in the specified order. Expected:<[2, 3, 1, 4]> but was:<[1, 2, 3, 4]>.");
        }
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2, 3, 4}, new FailDescription().addMessage("Message")).containsExactlyInOrder(Arrays.asList((short) 2, (short) 3, (short) 1, (short) 4));
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain all of the expected values exactly in the specified order. Expected:<[2, 3, 1, 4]> but was:<[1, 2, 3, 4]>.");
        }
    ...
    public void containsAnyTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAny((short) 3, (short) 4);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAny(3, 4);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain any of the expected values. Expected:<[3, 4]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsAny(Arrays.asList((short) 3, (short) 4));
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should contain any of the expected values. Expected:<[3, 4]> but was:<[1, 2]>.");
        }
    ...
    public void containsNoneTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsNone((short) 2, (short) 1);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsNone(2, 1);
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should not contain any of the expected values. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).containsNone(Arrays.asList((short) 2, (short) 1));
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Value should not contain any of the expected values. Expected:<[2, 1]> but was:<[1, 2]>.");
        }
    ...
    public void createListAssertionTest() {
        ...
        try {
            new ShortArrayAssertion(new short[]{1, 2}, new FailDescription().addMessage("Message")).createListAssertion().isEmpty();
            Assertions.fail("ShortArrayAssertion test fail");
        } catch (AssertionError ex) {
