...
public final class MockInputStreamTest extends AssertionTest {
    ...
    public void availableTest() throws IOException {
        ...
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent().buildInputStream().available()).isEqualTo(0);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1).buildInputStream().available()).isEqualTo(1);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2).buildInputStream().available()).isEqualTo(2);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2, 3).buildInputStream().available()).isEqualTo(3);
        ...
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2, 3).setAvailableException(false, new IOException("ex")).buildInputStream().available()).isEqualTo(3);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2, 3).setAvailableException(false, "ex").buildInputStream().available()).isEqualTo(3);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2, 3).setReadException("ex").buildInputStream().available()).isEqualTo(3);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2, 3).setSkipException("ex").buildInputStream().available()).isEqualTo(3);
        Assertions.assertThat(DataHelper.createInputStreamBuilder().setContent(1, 2, 3).setCloseException("ex").buildInputStream().available()).isEqualTo(3);

        InputStream inputStream01 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream();
        ...
        try {
            ...
            Assertions.fail(MockInputStream.class);
        ...
        InputStream inputStream02 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setAvailableException("fail").buildInputStream();
    ...
    public void readByteTest() throws IOException {
        InputStream inputStream01 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5, 0, 6, -5, -3).buildInputStream();
        ...
        InputStream inputStream02 = DataHelper.createInputStreamBuilder().setContent().buildInputStream();
        Assertions.assertThat(inputStream02.read()).isEqualTo(-1);

        InputStream inputStream03 = DataHelper.createInputStreamBuilder().setContent(1).setAvailableException("ex").buildInputStream();
        Assertions.assertThat(inputStream03.read()).isEqualTo(1);
        Assertions.assertThat(inputStream03.read()).isEqualTo(-1);

        InputStream inputStream04 = DataHelper.createInputStreamBuilder().setContent(1).setReadException(false, new IOException("ex")).buildInputStream();
        Assertions.assertThat(inputStream04.read()).isEqualTo(1);
        Assertions.assertThat(inputStream04.read()).isEqualTo(-1);

        InputStream inputStream05 = DataHelper.createInputStreamBuilder().setContent(1).setReadException(false, "ex").buildInputStream();
        Assertions.assertThat(inputStream05.read()).isEqualTo(1);
        Assertions.assertThat(inputStream05.read()).isEqualTo(-1);

        InputStream inputStream06 = DataHelper.createInputStreamBuilder().setContent(1).setSkipException("ex").buildInputStream();
        Assertions.assertThat(inputStream06.read()).isEqualTo(1);
        Assertions.assertThat(inputStream06.read()).isEqualTo(-1);

        InputStream inputStream07 = DataHelper.createInputStreamBuilder().setContent(1).setCloseException("ex").buildInputStream();
        ...
        InputStream inputStream08 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException("fail").buildInputStream();
        inputStream08.read();
        inputStream08.read();
        inputStream08.read();
    ...
    public void readByteArrayTest() throws IOException {
        InputStream inputStream01 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 0, 5, 6, -5).buildInputStream();
        ...
        InputStream inputStream02 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream();
        ...
        InputStream inputStream03 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream();
        ...
        InputStream inputStream04 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream();
        ...
        InputStream inputStream05 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5, 0, 6).buildInputStream();
        ...
        InputStream inputStream06 = DataHelper.createInputStreamBuilder().setContent().buildInputStream();
        ...
        InputStream inputStream07 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setAvailableException("ex").buildInputStream();
        ...
        InputStream inputStream08 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException(false, new IOException("ex")).buildInputStream();
        ...
        InputStream inputStream09 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException(false, "ex").buildInputStream();
        ...
        InputStream inputStream10 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setSkipException("ex").buildInputStream();
        ...
        InputStream inputStream11 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setCloseException("ex").buildInputStream();
        ...
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(null, 0, 10);
            Assertions.fail(MockInputStream.class);
        } catch (NullPointerException ex) {
            Assertions.assertThat(ex).hasMessage("buffer is null");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(null, -1, 10);
            Assertions.fail(MockInputStream.class);
        } catch (NullPointerException ex) {
            Assertions.assertThat(ex).hasMessage("buffer is null");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(new byte[5], -1, 10);
            Assertions.fail(MockInputStream.class);
        } catch (IndexOutOfBoundsException ex) {
            Assertions.assertThat(ex).hasMessage("offset is out of bounds");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(new byte[5], 5, 10);
            Assertions.fail(MockInputStream.class);
        } catch (IndexOutOfBoundsException ex) {
            Assertions.assertThat(ex).hasMessage("offset is out of bounds");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(new byte[5], 0, -1);
            Assertions.fail(MockInputStream.class);
        } catch (IndexOutOfBoundsException ex) {
            Assertions.assertThat(ex).hasMessage("length is out of bounds");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(new byte[5], 0, 6);
            Assertions.fail(MockInputStream.class);
        } catch (IndexOutOfBoundsException ex) {
            Assertions.assertThat(ex).hasMessage("length is out of bounds");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(new byte[5], 4, 2);
            Assertions.fail(MockInputStream.class);
        } catch (IndexOutOfBoundsException ex) {
            Assertions.assertThat(ex).hasMessage("length is out of bounds");
        }
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).buildInputStream().read(new byte[0], 1, 0);
            Assertions.fail(MockInputStream.class);
        } catch (IndexOutOfBoundsException ex) {
            Assertions.assertThat(ex).hasMessage("offset is out of bounds");
        }
        try {
            InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException(new IOException("fail")).buildInputStream();
        ...
        try {
            InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException(true, new IOException("fail")).buildInputStream();
            byte[] buff = new byte[10];
            inputStream.read(buff, 0, 10);
            Assertions.fail(MockInputStream.class);
        } catch (IOException ex) {
        ...
        try {
            InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException("fail").buildInputStream();
            byte[] buff = new byte[10];
            inputStream.read(buff, 0, 10);
            Assertions.fail(MockInputStream.class);
        } catch (IOException ex) {
        ...
        try {
            InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException(true, "fail").buildInputStream();
            byte[] buff = new byte[10];
            inputStream.read(buff, 0, 10);
            Assertions.fail(MockInputStream.class);
        } catch (IOException ex) {
        ...
        InputStream inputStream12 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setReadException("fail").buildInputStream();
    ...
    public void skipTest() throws IOException {
        ...
        InputStream inputStream04 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5, 0, 6).buildInputStream();
        Assertions.assertThat(inputStream04.skip(10)).isEqualTo(7);
        Assertions.assertThat(inputStream04.skip(10)).isEqualTo(0);
        Assertions.assertThat(inputStream04.skip(10)).isEqualTo(0);

        InputStream inputStream05 = DataHelper.createInputStreamBuilder().setContent().buildInputStream();
        Assertions.assertThat(inputStream05.skip(3)).isEqualTo(0);

        InputStream inputStream06 = DataHelper.createInputStreamBuilder().setContent(1).setAvailableException("ex").buildInputStream();
        Assertions.assertThat(inputStream06.skip(2)).isEqualTo(1);
        Assertions.assertThat(inputStream06.skip(2)).isEqualTo(0);

        InputStream inputStream07 = DataHelper.createInputStreamBuilder().setContent(1).setReadException("ex").buildInputStream();
        Assertions.assertThat(inputStream07.skip(2)).isEqualTo(1);
        Assertions.assertThat(inputStream07.skip(2)).isEqualTo(0);

        InputStream inputStream08 = DataHelper.createInputStreamBuilder().setContent(1).setSkipException(false, new IOException("ex")).buildInputStream();
        Assertions.assertThat(inputStream08.skip(2)).isEqualTo(1);
        Assertions.assertThat(inputStream08.skip(2)).isEqualTo(0);

        InputStream inputStream09 = DataHelper.createInputStreamBuilder().setContent(1).setSkipException(false, "ex").buildInputStream();
        Assertions.assertThat(inputStream09.skip(2)).isEqualTo(1);
        Assertions.assertThat(inputStream09.skip(2)).isEqualTo(0);

        InputStream inputStream10 = DataHelper.createInputStreamBuilder().setContent(1).setCloseException("ex").buildInputStream();
        ...
        InputStream inputStream11 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setSkipException("fail").buildInputStream();
        ...
        try {
            InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setSkipException("fail").buildInputStream();
            inputStream.skip(10);
            Assertions.fail(MockInputStream.class);
        } catch (IOException ex) {
            Assertions.assertThat(ex).hasMessage("fail");
    ...
    public void closeTest() throws IOException {
        ...
        DataHelper.createInputStreamBuilder().setContent().buildInputStream().close();
        DataHelper.createInputStreamBuilder().setContent(1).buildInputStream().close();
        DataHelper.createInputStreamBuilder().setContent(1).setAvailableException("ex").buildInputStream().close();
        DataHelper.createInputStreamBuilder().setContent(1).setReadException("ex").buildInputStream().close();
        DataHelper.createInputStreamBuilder().setContent(1).setSkipException("ex").buildInputStream().close();
        DataHelper.createInputStreamBuilder().setContent(1).setCloseException(false, new IOException("ex")).buildInputStream().close();
        DataHelper.createInputStreamBuilder().setContent(1).setCloseException(false, "ex").buildInputStream().close();
        ...
        try {
            DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setCloseException("fail").buildInputStream().close();
            Assertions.fail(MockInputStream.class);
        } catch (IOException ex) {
            Assertions.assertThat(ex).hasMessage("fail");
        }

        try (InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1).setCloseException("fail").buildInputStream()) {
            Assertions.assertThat(inputStream.read()).isEqualTo(1);
            Assertions.assertThat(inputStream.read()).isEqualTo(-1);
        } catch (IOException ex) {
            Assertions.assertThat(ex).hasMessage("fail");
        }
        try (InputStream inputStream = DataHelper.createInputStreamBuilder().setContent(1).setReadException("fail 1").setCloseException("fail 2").buildInputStream()) {
            Assertions.assertThat(inputStream.read()).isEqualTo(1);
            inputStream.read();
        } catch (IOException ex) {
    ...
    public void isClosedTest() throws IOException {
        ...
        InputStream inputStream02 = DataHelper.createInputStreamBuilder().setContent(1, 2, 3, 4, 5).setCloseException("fail").buildInputStream();
