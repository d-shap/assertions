...
public final class FailDescriptionTest extends AssertionTest {
    ...
    public void createAssertionErrorTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).createAssertionError()).hasMessage("message1.\n\tmessage2.");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").createAssertionError()).hasMessage("message1.\n\tmessage2.");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.");
    ...
    public void createAssertionErrorWithActualTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addActual(baseAssertion).createAssertionError()).hasMessage("message1.\n\tActual:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addActual(baseAssertion).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tActual:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tActual:<actualValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addActual(baseAssertion).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tActual:<actualValue>");
    ...
    public void createAssertionErrorWithExpectedTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue").createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue>");
    ...
    public void createAssertionErrorWithExpectedRangeTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue1:expectedValue2>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue1:expectedValue2>");
    ...
    public void createAssertionErrorWithActualAndExpectedTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue> but was:<actualValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue> but was:<actualValue>");
    ...
    public void createAssertionErrorWithActualAndExpectedRangeTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).toCause().isNull();
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
    ...
    public void createAssertionErrorWithThrowableTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addThrowable(new RuntimeException("error")).createAssertionError()).isCauseInstanceOf(RuntimeException.class);
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.");
    ...
    public void createAssertionErrorWithActualAndThrowableTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addActual(baseAssertion).addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tActual:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addActual(baseAssertion).addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tActual:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tActual:<actualValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addThrowable(new RuntimeException("error")).createAssertionError()).isCauseInstanceOf(RuntimeException.class);
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addActual(baseAssertion).addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tActual:<actualValue>");
    ...
    public void createAssertionErrorWithExpectedAndThrowableTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).isCauseInstanceOf(RuntimeException.class);
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue>");
    ...
    public void createAssertionErrorWithExpectedRangeAndThrowableTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue1:expectedValue2>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).isCauseInstanceOf(RuntimeException.class);
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue1:expectedValue2>");
    ...
    public void createAssertionErrorWithActualAndExpectedAndThrowableTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue> but was:<actualValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).isCauseInstanceOf(RuntimeException.class);
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue> but was:<actualValue>");
    ...
    public void createAssertionErrorWithActualAndExpectedRangeAndThrowableTest() {
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), null, null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", null).addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
        ...
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).isCauseInstanceOf(RuntimeException.class);
        Assertions.assertThat(new FailDescription(new FailDescription("message1"), "message2", "parameter").addActual(baseAssertion).addExpected(baseAssertion, "expectedValue1", "expectedValue2").addThrowable(new RuntimeException("error")).createAssertionError()).hasMessage("message1.\n\tmessage2: parameter.\n\tExpected:<expectedValue1:expectedValue2> but was:<actualValue>");
