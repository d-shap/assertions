...
public final class IntAssertionTest {
    ...
    public void isEqualToTest() {
        ...
        try {
            new IntAssertion(10, new FailDescription().addMessage("Message")).isEqualTo(20);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isNotEqualToTest() {
        ...
        try {
            new IntAssertion(10, new FailDescription().addMessage("Message")).isNotEqualTo(10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isGreaterThanTest() {
        ...
        try {
            new IntAssertion(10, new FailDescription().addMessage("Message")).isGreaterThan(10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new IntAssertion(10, new FailDescription().addMessage("Message")).isGreaterThan(11);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isGreaterThanOrEqualToTest() {
        ...
        try {
            new IntAssertion(10, new FailDescription().addMessage("Message")).isGreaterThanOrEqualTo(11);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isLessThanTest() {
        ...
        try {
            new IntAssertion(10, new FailDescription().addMessage("Message")).isLessThan(10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new IntAssertion(11, new FailDescription().addMessage("Message")).isLessThan(10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isLessThanOrEqualToTest() {
        ...
        try {
            new IntAssertion(11, new FailDescription().addMessage("Message")).isLessThanOrEqualTo(10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isInRangeTest() {
        ...
        try {
            new IntAssertion(5, new FailDescription().addMessage("Message")).isInRange(1, 5);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new IntAssertion(5, new FailDescription().addMessage("Message")).isInRange(6, 10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new IntAssertion(5, new FailDescription().addMessage("Message")).isInRange(8, 9);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void isNotInRangeTest() {
        ...
        try {
            new IntAssertion(5, new FailDescription().addMessage("Message")).isNotInRange(4, 6);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new IntAssertion(5, new FailDescription().addMessage("Message")).isNotInRange(5, 6);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
        ...
        try {
            new IntAssertion(5, new FailDescription().addMessage("Message")).isNotInRange(1, 10);
            Assertions.fail("IntAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void asStringTest() {
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(null, true)).isNull();
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(5, true)).isEqualTo("5");
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(60, true)).isEqualTo("60");
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(244, true)).isEqualTo("244");
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString("test", true)).isEqualTo("test");

        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(null, false)).isNull();
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(5, false)).isEqualTo("5");
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(60, false)).isEqualTo("60");
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString(244, false)).isEqualTo("244");
        Assertions.assertThat(new IntAssertion(5, new FailDescription()).asString("test", false)).isEqualTo("test");
    }
