...
public final class CollectionAssertionTest {
    ...
    public void toSizeTest() {
        ...
        try {
            new CollectionAssertion(Arrays.asList("val1", "val2", "val3"), new FailDescription().addMessage("Message")).toSize().isEqualTo(4);
            Assertions.fail("CollectionAssertion test fail");
        } catch (AssertionError ex) {
    ...
    public void hasSizeTest() {
        ...
        try {
            new CollectionAssertion(null, new FailDescription()).hasSize(3);
            Assertions.fail("CollectionAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Value should not be null.");
        }
        ...
        try {
            new CollectionAssertion(Arrays.asList("val1", "val2", "val3"), new FailDescription().addMessage("Message")).hasSize(4);
            Assertions.fail("CollectionAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Check value size. Values should be the same. Expected:<4> but was:<3>.");
        }
