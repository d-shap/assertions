...
public final class CollectionAssertionTest {
    ...
    public void containsAllInAnyOrderTest() {
        ...
        try {
            new CollectionAssertion(null, null).containsAllInAnyOrder("val");
            Assertions.fail("Collection assertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Value should not be null.");
        }
        try {
            new CollectionAssertion(Arrays.asList("val1", "val2"), null).containsAllInAnyOrder((Object[]) null);
            Assertions.fail("Collection assertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Argument should not be null.");
        }
    ...
    public void containsExactlyInAnyOrderTest() {
        ...
        try {
            new CollectionAssertion(null, null).containsExactlyInAnyOrder("val");
            Assertions.fail("Collection assertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Value should not be null.");
        }
        try {
            new CollectionAssertion(Arrays.asList("val1", "val2"), null).containsExactlyInAnyOrder((Object[]) null);
            Assertions.fail("Collection assertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Argument should not be null.");
        }
