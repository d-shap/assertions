...
public final class IteratorAssertionTest extends AssertionTest {
    ...
    public void toListFullTest() {
        ...
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Check iterator elements. Value should not be null.");
        }
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Message. Check iterator elements. Value should not be null.");
        }
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Check iterator elements. Value should contain all of the expected values exactly in the specified order. Expected:<[val1, val4]> but was:<[val1, val2, val3, val4]>");
        }
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Message. Check iterator elements. Value should contain all of the expected values exactly in the specified order. Expected:<[val1, val4]> but was:<[val1, val2, val3, val4]>");
        }
    }
    ...
    public void toListWithSizeTest() {
        ...
        try {
            clearActual(initialize(Raw.<String>iteratorAssertion(), Arrays.asList("val1", "val2", "val3", "val4").iterator()).toList(5)).containsExactlyInOrder("val");
            Assertions.fail("IteratorAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Check iterator elements. Value should not be null.");
        }
        try {
            clearActual(initialize(Raw.<String>iteratorAssertion(), Arrays.asList("val1", "val2", "val3", "val4").iterator(), "Message").toList(5)).containsExactlyInOrder("val");
            Assertions.fail("IteratorAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Check iterator elements. Value should not be null.");
        }
    ...
    public void containsTest() {
        ...
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Message. Check iterator elements. Value should contain the expected value. Expected:<val3> but was:<[val1, val2]>");
        }
    }
    ...
    public void toSizeTest() {
        ...
        try {
            ...
            Assertions.assertThat(ex).hasMessage("Check iterator elements. Check value's size. Value should not be null.");
        }
        try {
            clearActual(initialize(Raw.<String>iteratorAssertion(), Arrays.asList("val1", "val2", "val3").iterator(), "Message").toSize()).isEqualTo(1);
            Assertions.fail("IteratorAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Check iterator elements. Check value's size. Value should not be null.");
        }
        try {
            initialize(Raw.<String>iteratorAssertion(), Arrays.asList("val1", "val2", "val3").iterator()).toSize().isEqualTo(4);
            Assertions.fail("IteratorAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Check iterator elements. Check value's size. Values should be the same. Expected:<4> but was:<3>");
        }
        try {
            initialize(Raw.<String>iteratorAssertion(), Arrays.asList("val1", "val2", "val3").iterator(), "Message").toSize().isEqualTo(4);
            Assertions.fail("IteratorAssertion test fail");
        } catch (AssertionError ex) {
            Assertions.assertThat(ex).hasMessage("Message. Check iterator elements. Check value's size. Values should be the same. Expected:<4> but was:<3>");
        }
    }
