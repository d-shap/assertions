...
/**
 * Value converter from the list iterator to the list.
 *
 * @author Dmitry Shapovalov
 */
public final class ListIteratorToListValueConverter implements ValueConverterProvider {

    /**
     * Create new object.
     */
    public ListIteratorToListValueConverter() {
        super();
    }
    ...
    public Object convert(final Object value, final Object... arguments) {
        ListIterator<?> castedValue = ConverterArgumentHelper.getValue(value, ListIterator.class);
        ...
        if (castedForward) {
            ...
            for (int i = 0; (castedCount == 0 || i < castedCount) && castedValue.hasPrevious(); i++) {
                Object element = castedValue.previous();
                result.add(element);
            }
        }
        return result;
