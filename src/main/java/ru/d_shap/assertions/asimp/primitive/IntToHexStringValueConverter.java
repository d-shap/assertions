...
/**
 * Value converter from the int to the hex string.
 *
 * @author Dmitry Shapovalov
 */
public final class IntToHexStringValueConverter implements ValueConverterProvider {

    /**
     * Create new object.
     */
    public IntToHexStringValueConverter() {
        super();
    }
