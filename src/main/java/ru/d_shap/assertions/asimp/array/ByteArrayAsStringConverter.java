...
/**
 * Value to string converter for the byte array.
 *
 * @author Dmitry Shapovalov
 */
public final class ByteArrayAsStringConverter implements AsStringConverterProvider {

    /**
     * Create new object.
     */
    public ByteArrayAsStringConverter() {
        super();
    }
