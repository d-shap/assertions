...
/**
 * Value converter from the byte array to the hex string.
 *
 * @author Dmitry Shapovalov
 */
public final class ByteArrayToHexStringValueConverter implements ValueConverterProvider {

    /**
     * Create new object.
     */
    public ByteArrayToHexStringValueConverter() {
        super();
    }
