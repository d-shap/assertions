...
/**
 * Value to string converter for the float array.
 *
 * @author Dmitry Shapovalov
 */
public final class FloatArrayAsStringConverter implements AsStringConverterProvider {

    /**
     * Create new object.
     */
    public FloatArrayAsStringConverter() {
        super();
    }
