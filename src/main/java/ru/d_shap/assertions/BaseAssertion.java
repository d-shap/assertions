...
public abstract class BaseAssertion<T> {
     ...
     * @param <U>     the generic type of the actual value.
     */
    protected final <U> void matcherAssertion(final U actual, final Matcher<? super U> matcher) {
        checkInitialized();
     ...
     * @param <U>       the generic type of the actual value.
     */
    protected final <U> void matcherAssertion(final U actual, final Matcher<? super U> matcher, final String message, final Object... arguments) {
        checkInitialized();
