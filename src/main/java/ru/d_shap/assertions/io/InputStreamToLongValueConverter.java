...
/**
 * Value converter from the input stream to the long.
 *
 * @author Dmitry Shapovalov
 */
public final class InputStreamToLongValueConverter extends BaseValueConverter {

    /**
     * Create new object.
     */
    public InputStreamToLongValueConverter() {
        super();
    }
